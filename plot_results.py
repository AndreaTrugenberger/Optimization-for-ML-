# Generate 3 figures from the results.json file produced by train.py
...
# FIGURE 3: Best accuracy vs batch size      
...
def main():
    ...
    parser.add_argument("--batch_sizes", nargs="+", type=int, default=[32, 128, 512, 1024])
    parser.add_argument("--baseline_bs", type=int, default=128, help="Batch size used for Figure 1 baseline plots")
